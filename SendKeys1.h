#ifndef __SENDKEYS1_04192004__INC__
#define __SENDKEYS1_04192004__INC__

#include <windows.h>
#include <tchar.h>
#include <winable.h>
#include <tchar.h>
// Please see SendKeys.cpp for copyright and usage issues.	// Permit use of features specific to Windows NT 4.0 or later.
//#define _WIN32_WINNT 0x0600	// Change this to the appropriate value to target
...
public:
  ...
  bool SendKeys(LPCTSTR KeysString, int Wait);
